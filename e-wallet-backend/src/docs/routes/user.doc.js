 ...
 * message: { type: string, example: "PIN transaksi berhasil diaktifkan." }
 * 400:
 ...
 * properties:
 * status: { type: string, example: "success" }
 * message: { type: string, example: "Verifikasi KYC berhasil dikonfirmasi. Akun Anda kini berstatus Premium." }
 * 400:
 * $ref: '#/components/responses/400BadRequest'
 * 401:
 * $ref: '#/components/responses/401Unauthorized'
