...
| **Code Readiness** | 🟢 Siap | Kontrak komponen siap diteruskan ke Tim Arsitektur & Mobile Frontend Engineering. |
...
- [x] Sistem token semantik didefinisikan di [`tokens/colors.json`](tokens/colors.json).
...
- [x] Galeri Showcase Visual terbit di [`screens/showcase/specs.md`](screens/showcase/specs.md) siap disematkan ke `README.md`.
